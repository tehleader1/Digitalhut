...
assert.match(drawerSource, /shouldCreateUser:true, emailRedirectTo:MEMBER_REDIRECT_URL/)
assert.match(drawerSource, /MEMBER_REDIRECT_URL = "https:\/\/www\.digitalhut\.app"/)
assert.match(drawerSource, /try \{[\s\S]*catch \{[\s\S]*finally \{/)
