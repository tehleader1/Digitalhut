...
const queueKey = "digitalhut:dailySituationQueue:v6"
...
export default function DailySituationQueuePage(){
  ...
  function refreshDiscovery(){
    ["digitalhut:dailySituationQueue", "digitalhut:dailySituationQueue:v2", "digitalhut:dailySituationQueue:v3", "digitalhut:dailySituationQueue:v4", "digitalhut:dailySituationQueue:v5", "digitalhut:dailySituationQueue:v6"].forEach((key) => window.localStorage.removeItem(key))
